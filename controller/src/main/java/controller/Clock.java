...
public class Clock extends Thread {
	 ...
	 */
	public static int DEFAULT_TICK_INTERVAL = 1000;
	 ...
	 * 
	 * @param controller
	 *            - controller clock for the controller
	 */
	 ...
	 * 
	 * @param tickInterval
	 *            - tickInterval the interval between two ticks.
	 */
	 ...
	 * 
	 * @param tickInterval
	 *            - tickInterval The new interval in milliseconds.
	 */
